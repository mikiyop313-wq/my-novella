export const INFO_MESSAGES = {
  ...
  AI_PROMPT: {
    WORD_COUNT: `<span class="info-header">Word Count Limit</span><p>Set the number of words you want the AI to generate.</p><p>Please be aware that, depending on the model and the number of words selected, the AI may stop either before or after the selected range of words. It is recommended that you select between 200 and 5,000 words.</p>`,
